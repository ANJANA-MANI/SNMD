...
<li class="menu__item menu__item--current"><a href="Setting.jsp" class="menu__link"><span class="menu__helper">Setting</span></a></li>
...
<div style="margin-left:40%;margin-top:5%"><input type="button" value="Change Profile Picture" class="btn" onclick="change_pro()"></br><br>
<div id="output"></div>
<input type="button" value="Change Cover Picture" class="btn" onclick="change_cover()"></br><br> 
<div id="output1"></div>   
<input type="button" value="Change Password" class="btn" onclick="change_pass()"></br><br> 
<div id="output2"></div>
<a href="delete_profile.jsp" class="btn" style="margin-left:10px">Delete Profile</a>
</div>
