...
<li class="menu__item menu__item--current"><a href="add_bull.jsp" class="menu__link"><span class="menu__helper">Add Bulling</span></a></li>
...
<form action="bull_name_action.jsp" method="post">
<h3 style="margin-right:350px">Add Swear Word</h3>
<input type="text" name="bull_name" id="id_first_name" placeholder="Bull name" required="" style="width:50%"><br>
<input type="submit" value="Submit" style="width:20%;margin-left:20%">   
</form>
</div>
<div style="margin-left:30%;margin-top:30px">
<h3 style="margin-right:250px">Add Swear Word Through Url</h3>
<input type="button" onclick="bull_extract();move();" value="Extract Swear Word" class="button_style" style="margin-left:25%"/>
...
<h3 style="margin-right:300px">Manage Swear Word</h3>   
<%
Database db=new Database();
String query="select count(*) as c from tbl_bull_name";   
int cs=0;
...
<th>Delete</th>
 ...
 <%
String query1="select * from  tbl_bull_name";
...
<tr style="color:#000000;margin-left: 100px">
   ...
   <td><a href="update_swear_word.jsp?id=<%=rs.getString("id")%>">Update</a></td>
   <td><a href="delete_swear_word.jsp?id=<%=rs.getString("id")%>">Delete</a></td>
</tr>
<% 
                   }}
                    else
