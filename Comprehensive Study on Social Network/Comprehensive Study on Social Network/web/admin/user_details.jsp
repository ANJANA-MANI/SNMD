...
<li class="menu__item menu__item--current menu__item--current"><a href="user_details.jsp" class="menu__link"><span class="menu__helper">User Details</span></a></li>
...
String query="select count(*) as c from tbl_login where user_type='user'";   
int cs=0;
...
<th>Gender</th>
 ...
 <%
String query1="select * from  tbl_register as r inner join tbl_login as l on r.log_id=l.login_id where l.user_type='user'";
