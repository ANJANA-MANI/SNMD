...
<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="menu menu--francisco">
								<ul class="nav navbar-nav menu__list">
									...
									<li class="menu__item menu__item--current"><a href="Register.jsp" class="menu__link"><span class="menu__helper">Create New Account</span></a></li>
	...
	<!--banner-->
		...
		<!--footer-->
                ...
                <div style="float:left; width: 20%; margin-left: 300px;"><img src="images/reg_icon.jpg"/></div>
					<div style="width:50%; float:right;">
                                            <div class="modal-body real-spa">
							<div class="login-grids">
                                            <div class="login">
					<div class="reg-right">
		<form action="register_action.jsp" method="post" onsubmit="return validation();" name="f1">
                        <h3 style="margin-right:300px">Register </h3>
           <input type="text" name="first_name" id="id_first_name" placeholder="First Name" required="">
                      <input type="text" name="last_name" id="id_last_name" placeholder="Last Name" required="">
                        <input type="text" name="date_of_birth"  id="dob"  class="datepicker"  placeholder="Date Of Birth" required="">
            <select name="gender" id="gender" class="gender"><option value="0">Select</option><option>Male</option>
             <option>Female</option></select>
      <input type="text" name="email_id" id="id_email_id" placeholder="Email Id" required="">
...
<input type="password" name="confirm_password"  id="id_con_password" placeholder=" Confirm Password" required="">	
								...
								<div class="login">
									<div class="login-right">
										<form action="login_action.jsp" method="post">
											<h3>Sign In</h3>
                                                                                        <input type="text" name="Email" onfocus="this.value = '';" placeholder="Email id" required="">	
