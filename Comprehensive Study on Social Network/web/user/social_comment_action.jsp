...
temp=temp;
db.exupdate("insert into tbl_block(user_id,swear_word,swear_word_use,date,status)values('"+id+"','"+bid+"','Social_comment','"+today_date+"','0')");       
}
}
}
...
temp=temp.replace(arr[i], encoded);
temp=temp;
db.exupdate("insert into tbl_block(user_id,swear_word,swear_word_use,date,status)values('"+id+"','"+qid+"','social_comment','"+today_date+"','0')");
}
}
}

db.exupdate("insert into tbl_social_comment(user_id,s_id,comment)values('"+id+"','"+status_id+"','"+temp+"')");
