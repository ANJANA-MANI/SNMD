...
<li class="menu__item menu__item--current"><a href="view_group.jsp" class="menu__link"><span class="menu__helper">View Group</span></a></li>
...
<div class="section-title text-center wow fadeInDown">
           ...
           <%
                ...
                String gname="",userid="",fname="",lname="";
                 int c=0,c1=0;
               
               
                String qu="select count(distinct(gname)) as c from tbl_group where user_id='"+id+"'";
                ResultSet rss=db.exquery(qu);
                while(rss.next())
                     {
                      c=rss.getInt("c");
                     }
                if(c>0)
                     {   
           %>     
              <table borde="10" cellspacing="3" cellpadding="10" style="border-color: black;height: 200px;width: 500px;background-color: #D1D0CE;border-radius: 5px;margin-left:210px;">
       
           <tr>        
                <th style="padding-bottom: 50px;padding-left: 20px;font-size: 30px;color: black;">Your Created Groups</th>                 
    ...
    <%
                ...
                String s3="select distinct(gname) from tbl_group where user_id='"+id+"'";     
                ResultSet rs=db.exquery(s3);           
                while(rs.next()){
            ...
            <td style="width: 400px;padding-left: 100px;">
            <font style="padding-left: 10px;font-size: 20px"><a style="text-decoration: underline;" href="members.jsp?id=<%=gname%>"><%=gname%></a></font>
            </td><td><a style="margin-bottom: 8px;"class="btn btn_s btn-danger" href="del_grp.jsp?id=<%=gname%>">Delete Group</a>
            </td>
        ...
        <div style="font-size: 20px;color: #E5E4E2; background-color: #00C7FC;padding: 20px; width: 500px">You are not created groups</div>
    </center>
           <%
                  } 
            %>
...
<div class="section-title text-center wow fadeInDown">  
  ...
  <table borde="10" cellspacing="3" cellpadding="10" style="border-color: black;height: 200px;width: 500px;background-color: #D1D0CE;border-radius: 5px;margin-left:210px;">                            
         <%
                ...
                String qry="update tbl_group set status='1' where log_id='"+id+"'";                              
                int i=db.exupdate(qry);
                String q="select count(distinct(gname)) as c from tbl_group where log_id='"+id+"'";
                ResultSet rss1=db.exquery(q);
                while(rss1.next())
                     {
                      c1=rss1.getInt("c");
                     }
           ...
           %>            
                ...
                <tr>        
                <th style="padding-bottom: 50px;padding-left: 20px;font-size: 30px;color: black;">Tagged Groups</th>                 
                <th style="padding-left: 30px;"></th>  
                <br><br>
                </tr>  
    <%
                 
                String gname1="",userid1="",fname1="",lname1="";
                
                String s3="select distinct(gname) from tbl_group where log_id='"+id+"'";     
                ResultSet rs1=db.exquery(s3);           
                while(rs1.next()){
                     gname1=rs1.getString("gname");   
                     System.out.println("gname "+gname1);
                                           
            %>            
             
            <tr style="color: white;">
            <td style="width: 400px;padding-left: 100px;">
            <font style="padding-left: 10px;font-size: 20px"><a style="text-decoration: underline;" href="members.jsp?id=<%=gname1%>"><%=gname1%></a></font>
            </td><td><a style="margin-bottom: 8px;"class="btn btn_s btn-danger" href="exit_grp.jsp?id=<%=gname1%>">Exit Group</a> </td> 
            </tr>    
            <%
                }    
            %>
            ...
            %>
           <center><br><br><br><br><br><br><br><br><br><br>  
        <div style="font-size: 20px;color: #E5E4E2; background-color: #00C7FC;padding: 20px; width: 500px">You have no tagged groups</div>
    </center>
           <%
                  } 
            %>
