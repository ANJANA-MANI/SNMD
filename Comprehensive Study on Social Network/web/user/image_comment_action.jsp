...
temp=temp;
db.exupdate("insert into tbl_block(user_id,swear_word,swear_word_use,date,status)values('"+id+"','"+bid+"','image_comment','"+today_date+"','0')");       
}
}
}
...
temp=temp.replace(arr[i], encoded);
temp=temp;
db.exupdate("insert into tbl_block(user_id,swear_word,swear_word_use,date,status)values('"+id+"','"+qid+"','image_comment','"+today_date+"','0')");
}
}
}

db.exupdate("insert into tbl_image_comment(user_id,image_id,image_comment)values('"+id+"','"+image_id+"','"+temp+"')");
