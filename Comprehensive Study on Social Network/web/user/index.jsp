...
<tr><td colspan="4"><span class="blink_me"><h2 style="color:#05222A;text-align:center;">Home-Status</h2></span></td></tr><tr>
<%
...
<form action="status_comment_action.jsp">
    <tr><td style="padding: 20px;"><mark><b>Name:<%=ab1.getString("first_name")+" "+ab1.getString("last_name")%></b></mark></td></tr>
    <tr><td style="padding: 20px;"><h4>Status:<%=ab1.getString("statuss")%></h4></td></tr>
    ...
    <tr><td style="padding: 20px;"><h5><%=m.getString("first_name")+" "+m.getString("last_name")%>:<%=m.getString("comment")%></h5></td></tr>

    <%}
    %>
    <tr><td style="padding: 20px;"><input type="text" name="comment" placeholder="Add comment" required="" spellcheck="true"/>
...
%>
<form action="status_comment_action.jsp">
    <tr><td style="padding: 20px;"><mark><b>Name:<%=ab.getString("first_name")+" "+ab.getString("last_name")%></b></mark></td></tr>
    <tr><td style="padding: 20px;"><h4>Status:<%=ab.getString("statuss")%></h4></td></tr>
    <tr><td style="padding: 20px;color: blue;"><h3>comments</h3></td></tr> 
    <%
...
%>
    ...
    <tr><td style="padding: 20px;"><input type="text" name="comment" placeholder="Add comment" required="" spellcheck="true"/>
     <input type="hidden" name="status_id" value="<%=status_id%>"/>   
    <input type="submit" value="Add Comment"/></td></tr></form>  </div>
     
<%}}
%>
<tr></tr><tr></tr></table></div></div></div>

<div class="profile" >
   <div style="margin-left:30%;">
       <div style="border:solid; width:80%;padding: 100px;">
           <table cellpadding="6" cellspacing="7">
               <tr><td colspan="4"><span class="blink_me"><h2 style="color:#05222A;text-align:center;">Social Voting</h2></span></td></tr>
<%
...
%>   
<tr><td style="padding: 20px;"><input type="image" src=".../images/like.png" alt="submit" onclick="form.action='like_action.jsp';" width="48" height="48"><%=like%></td></form>
<form action="dislike_action.jsp">
    <input type="hidden" name="sid" value="<%=sid%>"/>
<%
...
%> 
<td><input type="image" src=".../images/dislike.png" alt="submit" onclick="form.action='dislike_action.jsp';" width="48" height="48"><%=dislike%></td></form></tr>
...
%>
    ...
    <tr><td style="padding: 20px;"><h5><%=m1.getString("first_name")+" "+m1.getString("last_name")%>:<%=m1.getString("comment")%></h5></td></tr>

    <%}
    %>
<form action="social_comment_action.jsp">
        <tr><td style="padding: 20px;"><input type="text" name="comment" placeholder="Add comment" required="" spellcheck="true"/>
...
<form action="image_comment_action.jsp">
    <tr><td style="padding: 20px;"><mark><b>Name:<%=abc.getString("first_name")+" "+abc.getString("last_name")%></b></mark></td></tr>
    <tr><td style="padding: 20px;"><mark><b>Description:<%=abc.getString("description")%></b></mark></tr>
    <tr><td style="padding: 20px;"><img src="../proimage/<%=abc.getString("image")%>" height="500" width="600"></td></tr>
    <tr><td style="padding: 20px;color: blue;"><h3>comments</h3></td></tr> 
    <%
    ...
    <tr><td style="padding: 20px;"><h5><%=m.getString("first_name")+" "+m.getString("last_name")%>:<%=m.getString("image_comment")%></h5></td></tr>
...
%>
<form action="image_comment_action.jsp">
    <tr><td style="padding: 20px;"><mark><b>Name:<%=a2.getString("first_name")+" "+a2.getString("last_name")%></b></mark></td></tr>
    <tr><td style="padding: 20px;"><mark><b>Description:<%=a2.getString("description")%></b></mark></tr>
    <tr><td style="padding: 20px;"><img src="../proimage/<%=a2.getString("image")%>" height="500" width="600"></td></tr>
    <tr><td style="padding: 20px;color: blue;"><h3>comments</h3></td></tr> 
    <%
    ...
    <%}
    %>
    <tr><td style="padding: 20px;"><input type="text" name="comment" placeholder="Add comment" required=""/>
