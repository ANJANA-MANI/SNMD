...
<%}%>
            ...
            <table cellspacing="3" cellpadding="10" style="border-color: black;height: 200px;width: 500px;background-color: #D1D0CE;border-radius: 5px;margin-left:205px;">
                <tr><td style="color: black;padding-left: 50px;padding-top: 20px" >Group Name</td><td><input name="gname" type="text" id="gname" required="" style="margin-top: 20px" ></td></tr>
                    <tr><td style="color: black;padding-left: 50px;padding-top: 20px" >Select Members</td>
