...
<table>
     <tr><td><span class="blink_me"><h2>Friends List</h2></span></td></tr><tr>
<%
     Database qb=new Database();         
     String qe="select * from tbl_request as r right join tbl_register as g on r.friend_id=g.log_id inner join tbl_login as l on l.login_id=r.friend_id where r.user_id='"+id+"' and r.status='3'";
     ResultSet rx=qb.exquery(qe);
    
     
while(rx.next())
              {
                  %>
 <td><img src="../proimage/<%=rx.getString("profile")%>" height="200" width="200"></a>
 <mark><b><%=rx.getString("first_name")+" "+rx.getString("last_name")%></b></mark></br></td>

           <%}
  String q1="select * from tbl_request as r right join tbl_register as g on r.user_id=g.log_id inner join tbl_login as l on l.login_id=r.user_id where r.friend_id='"+id+"' and r.status='3'";
     ResultSet r1=qb.exquery(q1);
    
     
while(r1.next())
              {
                  %>
 <td><img src="../proimage/<%=r1.getString("profile")%>" height="200" width="200"></a>
 <mark><b><%=r1.getString("first_name")+" "+r1.getString("last_name")%></b></mark></br></td>
