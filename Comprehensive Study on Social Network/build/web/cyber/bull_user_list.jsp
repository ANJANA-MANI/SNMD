...
<li class="menu__item menu__item--current"><a href="bull_user_list.jsp" class="menu__link"><span class="menu__helper">Bulling Word user list</span></a></li>
...
String query="select count(*) as c from tbl_block where status='0'";   
int cs=0;
...
<th>Action</th>
 ...
 <%
String query1="select * from  tbl_block as b inner join tbl_register as r on b.user_id=r.log_id inner join tbl_bull_name n on n.id=b.swear_word where b.status='0'";
...
<tr style="color:#000000;margin-left: 100px">
   ...
   <td><a href="block_action.jsp?id=<%=rs.getString("id")%>">Block</a></td>
   </tr>
<% 
                   }}
                    else
