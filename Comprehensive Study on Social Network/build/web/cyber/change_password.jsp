...
<li class="menu__item menu__item--current"><a href="change_password.jsp" class="menu__link"><span class="menu__helper">Change Password</span></a></li>
<li class="menu__item"><a href="bull_user_list.jsp" class="menu__link"><span class="menu__helper">Bulling Word user list</span></a></li>
<li class="menu__item"><a href="bull_group_list.jsp" class="menu__link"><span class="menu__helper">Bulling Word Group list</span></a></li>
...
%>
<div style="width:60%;float:right;"> <div style="margin-top:25px;margin-left:5%"><h2 style="color:#000000;"><b><u>Change Profile Password</u></b></h2>
<div class="login-right">
<form name="f1" action="change_password_action.jsp" method="post">
<input type="text" name="email" value="<%=email_id%>" style="width:50%"><br>
<input type="text" name="pass" value="<%=dec_pass%>" style="width:50%"><br>
<input type="submit" value="Update Password" style="width:30%;margin-left:10%">  
</form>
</div> </div></div>
