...
<div class="dropdown">
      <li class="dropbtn" class="menu__item menu__item--current" class="menu__link" class="menu__helper">Users</li>                                                            
...
<h3 style="margin-right:30%">User Details</h3>   
<%
...
<h3 style="margin-right:30%">Group Details</h3>    
 <%
String q="select count(*) as c from tbl_group_block where status='1'";   
int cp=0;
...
<%
String q1="select * from  tbl_group_block as b inner join tbl_register as r on b.user_id=r.log_id inner join tbl_bull_name n on n.id=b.swear_word inner join tbl_group g on g.g_id=b.gp_id  where b.status='1'";
ResultSet rs=db.exquery(q1);
while(rs.next()){
%>
<tr style="color:#000000;margin-left: 100px">
   <td> <%=rs.getString("id")%></td>
   ...
   <td> <%=rs.getString("date")%></td>
   <td><a href="group_permanant_block_action.jsp?id=<%=rs.getString("id")%>">Block Permanently</a></td>
   </tr>
<% 
                   }}
                    else
