...
<li class="menu__item"><a href="../adminlogout.jsp" class="menu__link"><span class="menu__helper">Logout</span></a></li>
 ...
 ResultSet res=db.exquery("select * from tbl_bull_name where id='"+id+"'");
 String bull_name="";
 while(res.next())
 {
  bull_name=res.getString("bull_name");
 }
                    %>
<div class="login-right">	
<div style="margin-left:35%;">
<form action="bull_name_update_action.jsp" method="post">
<h3 style="margin-right:250px">Update Swear Word</h3>
<input type="text" name="bull_name" id="id_first_name" value="<%=bull_name%>" style="width:50%"><br>
